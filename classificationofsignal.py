...
from sklearn.preprocessing import LabelEncoder
from sklearn.pipeline import Pipeline
df = pd.read_excel('/Users/ahmedatia/ATIA/S D/SHM/Numerical_Work_NI&code /RFCNN.xlsx')
#
df.columns
result = df.head()
print (result)
...
def make_model(input_shape):
    ...
    conv1 = keras.layers.Conv1D(filters=64, kernel_size=5, padding="same",activation="leakyrelu")(input_layer)
    conv1 = keras.layers.BatchNormalization()(conv1)
    conv1 = keras.layers.ReLU()(conv1)
    conv1 = keras.layers.Dropout(0.2)(conv1)
